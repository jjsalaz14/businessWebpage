...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      // which is lazy-loaded when the route is visited.
      component: () =>
        import(/* webpackChunkName: "services" */ "./views/Deals.vue")
    },
    {
      path: "/edit-about",
      name: "edit-about",
      ...
      // which is lazy-loaded when the route is visited.
      component: () =>
        import(/* webpackChunkName: "edit-about" */ "./views/EditAbout.vue")
    },
    {
      path: "/edit-deals",
      name: "edit-deals",
    ...
    },
    {
      ...
      // which is lazy-loaded when the route is visited.
      component: () =>
        import(/* webpackChunkName: "add-inventory" */ "./views/AddInventory.vue")
    }
